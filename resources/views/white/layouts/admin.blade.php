...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all"
          href="{{ asset(config('settings.theme')) }}/css/style-minifield.css"/> <!-- MAIN THEME STYLESHEET -->
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(config('settings.theme')) }}/css/buttons.css"/>
    <!-- MAIN THEME STYLESHEET -->
    <link rel="stylesheet" type="text/css" media="all"
          href="{{ asset(config('settings.theme')) }}/css/cache-custom.css"/> <!-- MAIN THEME STYLESHEET -->
        ...
        <div id="header" class="group">
            ...
            <div class="group inner">
                ...
                <div id="logo" class="group">
                    <a href="{{ Route('home') }}" title="Pink Rio"><img
