                ...
                @foreach($portfolios as $portfolio)
                    <div class="hentry work group">
                        <div class="work-thumbnail">
                            <div class="nozoom">
                                <img src="{{ asset(config('settings.theme')) }}/images/portfolios/{{ $portfolio->img->max }}"
                                     alt="0061" title="0061"/>
                                <div class="overlay">
                                    <a class="overlay_img"
                                       href="{{ asset(config('settings.theme')) }}/images/portfolios/{{ $portfolio->img->path }}"
                        ...
                        <div class="work-description">
                            ...
                            <p>{!! str_limit($portfolio->text,800) !!}</p>
                            <div class="clear"></div>
